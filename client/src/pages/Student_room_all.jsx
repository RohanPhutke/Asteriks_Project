...
import StudentRoomComp from "./student_roomAllHcomp";
const Studentroomall = () => {
  ...
  <link rel="stylesheet" href="../styles/Student_room_all.module.css" />
  <div className="container">
    ...
    <div className="occupancy">
      ...
      <div className="occupancy-border">
        <StudentRoomComp hostelNo={1}></StudentRoomComp>
        <StudentRoomComp hostelNo={2}></StudentRoomComp>
        <StudentRoomComp hostelNo={3}></StudentRoomComp>
        <StudentRoomComp hostelNo={4}></StudentRoomComp>
        <StudentRoomComp hostelNo={5}></StudentRoomComp>
